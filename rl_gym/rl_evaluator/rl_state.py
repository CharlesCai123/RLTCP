"""
    Define all states for RL agent as training parameters
"""
...
from rl_gym.monitor.rl_monitor import BandwidthCollector
from rl_gym.monitor.rl_monitor import QueueCollector
from rl_gym.monitor.rl_monitor import FlowCollector
from rl_gym.rl_evaluator.rl_reward import RewardFunction
...
class StateManager:
    ...
    def _init_stats_matrices(self, num_ports, num_hosts):
        ...
        np_stats = rl_utils.shmem_to_nparray(mp_stats, np.float64)
        ...
        if (self.collect_flows):
            ...
            np_flows = rl_utils.shmem_to_nparray(mp_flows, np.uint8)
